...
(function (root, factory) {
	...
	function render(contentTree,navList){
		if(contentTree.pages){
			...
			//needs genericizing
			fs.mkdir(rootPath + "/o/styles/","0777",function(err){
				var stylePath = rootPath + "/themes/" + configuration.themeDir + "/styles/style.css";
				var oStylePath = rootPath + "/o/styles/style.css";
				copy(stylePath,oStylePath);
			});
			fs.mkdir(rootPath + "/o/images/","0777",function(err){
				var inP = rootPath + "/themes/" + configuration.themeDir + "/images/clip.png";
				var outP = rootPath + "/o/images/clip.png";
				copy(inP,outP);
			});
		} else {
	...
	return {
		...
		watchMode : function(){
			console.log(color.green+'Running in watch mode. Changes to files in site directories regenerate.'+color.reset)
